...
class Invoice{
  ...
  Invoice({ this.partnerDocumentNumber, this.partnerDocumentDate, this.partnerDocumentDueDatePayment, this.invoicePrice,
    ...
    this.filterEndPartnerDocumentDueDatePayment, this.filterStartPartnerDocumentDate, this.filterStartPartnerDocumentDueDatePayment, this.documentType, this.id, this.documentNumber, this.turnoverType, this.documentDate, this.quantity, this.vatRate, this.divide, this.confirmed, this.groupTopRecord, this.groupTotal});
