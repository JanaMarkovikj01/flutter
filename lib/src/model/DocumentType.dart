  ...
  String getType (DocumentType type){
    switch (type) {
      ...
      case DocumentType.TRANSFER: // Prenosnica;
        return "PRN";
      case DocumentType.PRICECHNG: // Promena na cena. Izvestaj za menuvanje na ceni;
        return "NIV";
      case DocumentType.INTERNALOUT: // Interna izlezna ispratnica.
      case DocumentType.INTERNALIN: // Interna izlezna ispratnica.
        return "INT";
      case DocumentType.INTERNALREIMBIN: // Interna prenosnica od komercijalna vo pozitivna
        return "PKP";
      case DocumentType.INTERNALREIMBOUT: // Interna prenosnica od pozitivna vo komercijalna
        return "PPK";
      default:
        return "";
    }
